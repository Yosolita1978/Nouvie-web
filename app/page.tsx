...
const categories = [
  {
    name: "Aseo Hogar",
    description: "Productos de limpieza ecológicos para tu hogar",
    href: "/productos?categoria=hogar",
    image: "/images/categoria-hogar.jpg",
  },
  {
    name: "Línea Capilar",
    description: "Tratamientos capilares naturales",
  ...
  },
  {
    ...
    href: "/productos?categoria=institucional",
          ...
          <div className="flex flex-col lg:flex-row lg:items-center min-h-[90vh] lg:min-h-screen py-8 lg:py-0">
            ...
            <div className="lg:w-[55%] lg:pr-12">
              ...
              <p className="animate-fade-up animation-delay-200 text-gray-600 text-lg md:text-xl mb-10 max-w-xl leading-relaxed">
                Creamos productos con ingredientes de alta calidad que mejoran nuestro
                bienestar y el de nuestras familias, brindándonos una mejor calidad de vida.
              </p>
      ...
      <section className="py-16 bg-nouvie-pale-blue/30">
        <div className="mx-auto max-w-7xl px-4 lg:px-8 text-center">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto mb-8">
            La filosofía de Nouvie consiste en el cuidado a tu salud y al medio ambiente.
            Buscamos la sostenibilidad y garantizar la adecuada disposición de nuestros envases.
          </p>
          <Link
            href="/filosofia"

...
export default async function FilosofiaPage() {
  ...
  const strongRose = (chunks: ReactNode) => (
    <strong className="text-rose-600">{chunks}</strong>
  );

  const strongEmerald = (chunks: ReactNode) => (
    <strong className="text-emerald-700">{chunks}</strong>
  );

  const keyBenefits = [
    {
      titleKey: "sustainability.benefit1Title" as const,
      descriptionKey: "sustainability.benefit1Description" as const,
      icon: (
    ...
    {
      titleKey: "sustainability.benefit2Title" as const,
      descriptionKey: "sustainability.benefit2Description" as const,
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      titleKey: "sustainability.benefit3Title" as const,
      descriptionKey: "sustainability.benefit3Description" as const,
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      titleKey: "sustainability.benefit4Title" as const,
      descriptionKey: "sustainability.benefit4Description" as const,
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  const certifications = [
    { nameKey: "certifications.cert1Name" as const, descriptionKey: "certifications.cert1Description" as const },
    { nameKey: "certifications.cert2Name" as const, descriptionKey: "certifications.cert2Description" as const },
    { nameKey: "certifications.cert3Name" as const, descriptionKey: "certifications.cert3Description" as const },
  ];

  const stats = [
    { valueKey: "stats.stat1Value" as const, labelKey: "stats.stat1Label" as const },
    { valueKey: "stats.stat2Value" as const, labelKey: "stats.stat2Label" as const },
    { valueKey: "stats.stat3Value" as const, labelKey: "stats.stat3Label" as const },
    { valueKey: "stats.stat4Value" as const, labelKey: "stats.stat4Label" as const },
  ];

  const operativeBenefits = [
    t("sustainability.operativeBenefit1"),
    t("sustainability.operativeBenefit2"),
    t("sustainability.operativeBenefit3"),
    t("sustainability.operativeBenefit4"),
  ];

  const trainingItems = [
    t("sustainability.training1"),
    t("sustainability.training2"),
    t("sustainability.training3"),
    t("sustainability.training4"),
  ];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-nouvie-navy via-slate-800 to-emerald-900 py-20 lg:py-32">
        ...
        <div className="relative mx-auto max-w-7xl px-4 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-6 animate-fade-up animation-delay-100 tracking-tight">
            {t("hero.title")}<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-nouvie-turquoise to-emerald-400">{t("hero.titleHighlight")}</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="animate-fade-up">
              <div className="bg-white rounded-3xl p-6 md:p-8 shadow-lg border border-gray-100 h-full">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    {t.rich("challenge.paragraph1", { strong: strongRose })}
                  </p>
                  <p>
                    {t("challenge.paragraph2")}
                  </p>
                  <p>
                    {t.rich("challenge.paragraph3", { strong: strongRose })}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="animate-fade-up animation-delay-200">
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-6 md:p-8 shadow-lg border border-emerald-100 h-full">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    {t.rich("solution.paragraph1", { strong: strongEmerald })}
                  </p>
                  <p>
                    {t("solution.paragraph2")}
                  </p>
                  <p>
                    {t.rich("solution.paragraph3", { strong: strongEmerald })}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
                  ...
                  {t("sustainability.operativeBenefitsTitle")}
                </h3>
                <ul className="space-y-4">
                  {operativeBenefits.map((item, i) => (
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-3">
                  ...
                  {t("sustainability.trainingTitle")}
                </h3>
                <ul className="space-y-4">
            ...
            {certifications.map((cert, i) => (
              ...
              >
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl font-black text-white">{t(cert.nameKey).split(" ")[0]}</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">{t(cert.nameKey)}</h3>
                <p className="text-white/70 text-sm">{t(cert.descriptionKey)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up animation-delay-300">
            ...
            <a
              href={`https://wa.me/573158326422?text=${encodeURIComponent(t("cta.whatsappMessage"))}`}
              target="_blank"

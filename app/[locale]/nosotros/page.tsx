...
export default async function NosotrosPage() {
  ...
  const highlightTag = (chunks: ReactNode) => (
    <span className="text-nouvie-navy font-medium">{chunks}</span>
  );

  const productLines = [
    {
      nameKey: "whoWeAre.line1Name" as const,
      descriptionKey: "whoWeAre.line1Description" as const,
      icon: (
    ...
    {
      nameKey: "whoWeAre.line2Name" as const,
      descriptionKey: "whoWeAre.line2Description" as const,
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      nameKey: "whoWeAre.line3Name" as const,
      descriptionKey: "whoWeAre.line3Description" as const,
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  const cultureValues = [
    {
      titleKey: "culture.value1Title" as const,
      descriptionKey: "culture.value1Description" as const,
      icon: (
    ...
    {
      titleKey: "culture.value2Title" as const,
      descriptionKey: "culture.value2Description" as const,
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      titleKey: "culture.value3Title" as const,
      descriptionKey: "culture.value3Description" as const,
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    {
      titleKey: "culture.value4Title" as const,
      descriptionKey: "culture.value4Description" as const,
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-16">
              ...
              <div className="lg:w-1/2 order-2 lg:order-1">
                ...
                <div className="flex gap-8 mt-8 animate-fade-up animation-delay-300">
                  <div>
                    <div className="text-3xl md:text-4xl font-bold text-nouvie-turquoise">{t("hero.stat1Value")}</div>
                    <div className="text-xs text-gray-500 uppercase tracking-wide mt-1">{t("hero.stat1Label")}</div>
                  </div>
                  <div>
                    <div className="text-3xl md:text-4xl font-bold text-nouvie-gold">{t("hero.stat2Value")}</div>
                    <div className="text-xs text-gray-500 uppercase tracking-wide mt-1">{t("hero.stat2Label")}</div>
                  </div>
                  <div>
                    <div className="text-3xl md:text-4xl font-bold text-nouvie-navy">{t("hero.stat3Value")}</div>
                    <div className="text-xs text-gray-500 uppercase tracking-wide mt-1">{t("hero.stat3Label")}</div>
                  </div>
                </div>
              </div>
        ...
        <div className="px-5 md:px-8 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-2xl mb-12 md:mb-16 animate-fade-up">
              <span className="text-nouvie-turquoise font-semibold text-sm tracking-widest uppercase">{t("whoWeAre.eyebrow")}</span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-nouvie-navy mt-3 mb-6">
                {t("whoWeAre.title")}
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                {t.rich("whoWeAre.description", {
                  highlight: highlightTag,
                })}
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto space-y-16 md:space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-start animate-fade-up">
              ...
              <div className="flex items-center gap-4 md:flex-col md:items-start">
                ...
                <span className="text-nouvie-turquoise font-bold text-sm tracking-widest uppercase md:mt-4">{t("mission.eyebrow")}</span>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-start animate-fade-up">
              ...
              <div className="flex items-center gap-4 md:flex-col md:items-start">
                ...
                <span className="text-nouvie-gold font-bold text-sm tracking-widest uppercase md:mt-4">{t("vision.eyebrow")}</span>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-8 inline-flex items-center gap-3 bg-nouvie-gold/10 border border-nouvie-gold/20 rounded-full px-5 py-2.5">
                  <span className="text-nouvie-gold font-bold text-2xl">{t("vision.badgeYear")}</span>
                  <span className="text-nouvie-navy text-sm font-medium">{t("vision.badgeLabel")}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative px-5 md:px-8 lg:px-12">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16 animate-fade-up">
              <span className="text-nouvie-turquoise font-semibold text-sm tracking-widest uppercase">{t("culture.eyebrow")}</span>
            ...
            <div className="mt-12 md:mt-16 text-center animate-fade-up animation-delay-300">
              <div className="inline-block bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl md:rounded-3xl p-6 md:p-8 max-w-3xl">
                <p className="text-white/80 text-base md:text-lg leading-relaxed">
                  {t.rich("culture.teamDescription", {
